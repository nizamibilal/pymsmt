...
def gene_pre_frcmod_file(ionids, naamol2f, stpdbf, stfpf, scresf, prefcdf,
    ...
    for i in list(bondparamsdict1.keys()):
      print('NON', i[0] + '-' + i[1] + bondparamsdict1[i], file=fmf)

    for i in list(bondparamsdict2.keys()):
    ...
    for i in list(angparamsdict1.keys()):
      print('NON', i[0] + '-' + i[1] + '-' + i[2] + angparamsdict1[i], file=fmf)
    for i in list(angparamsdict2.keys()):
    ...
    print(' ', file=fmf)
    print('DIHE', file=fmf)
    for keyv in list(dihparamsdict.keys()):
      if 'X ' not in keyv: #For types don't contain X
        ...
        for i in range(0, int(round(temp, 0))):
          temp1 = i * 3
          print('YES', keyv, valv[temp1] + valv[temp1+1] + \
                   valv[temp1+2], file=fmf)
