...
def write_leapin(ion0, ion1, watermodel):
    ...
    print("saveamberparm ion %s_wat_pvc.prmtop %s_wat_pvc.inpcrd" %(ion0.element, ion0.element), file=leapf)
    ...
    print("saveamberparm ion %s_wat_pc.prmtop %s_wat_pc.inpcrd" %(ion0.element, ion0.element), file=leapf)
...
def gene_topcrd(ion0, ion1, watermodel, ifc4=0, c4v=0.0):
    ...
    #tleap file
    write_leapin(ion0, ion1, watermodel)
